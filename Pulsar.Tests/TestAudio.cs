...
public static class TestAudio
{
    ...
    public static string WriteWav(string path, int sampleRate, int channels, double seconds,
    ...
    public static string WriteQuietFlac(string path, int sampleRate, int channels, double seconds,
        double amplitude = 0)
    {
        ...
        {
            SoundFileWriter.CreateSoundFile(path, reader, SoundFileMajorFormat.Flac,
